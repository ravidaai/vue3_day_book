        ...
        <Form @submit="handleSubmit" :validation-schema="schema">
          <div>
            <div class="form-floating">
              ...
              <label
                :for="
                  editMode == true ? 'edit_invoice_date' : 'add_invoice_date'
                "
                v-if="!editMode"
            ...
            <div class="form-floating">
              ...
              <label
                :for="
                  editMode == true ? 'edit_customer_name' : 'add_customer_name'
                "
                v-if="!editMode"
            ...
            <div class="form-floating">
              ...
              <label
                :for="editMode == true ? 'edit_particular' : 'add_particular'"
                v-if="!editMode"
            ...
            <div class="form-floating">
              ...
              <label
                :for="editMode == true ? 'edit_cash_in' : 'add_cash_in'"
                v-if="!editMode"
                >Add cash in</label
              >
              <label
            ...
            <div class="form-floating">
              ...
              <label
                :for="editMode == true ? 'edit_cash_out' : 'add_cash_out'"
                v-if="!editMode"
                >Add cash out</label
              >
              <label
             ...
             <Field as="select"  name="company"  class="form-control">
               <option>Select company</option>
          <option v-for="companyDropdown in companyDropdownGetter" :key="companyDropdown._id" :value="companyDropdown._id">{{ companyDropdown.company_name }}</option>
        </Field>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      companyDropdownGetter: "company/dropdown",
    }),
    options: () => [],
  },
  ...
  methods: {
    ...mapActions({
      ...
      companyDropdownAction: "company/dropdown",
    }),
